...
export function UserManagement() {
  ...
  // Anonymous → sign-in prompt. Authenticated non-admin → access denied.
  if (!currentUser) {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center max-w-md px-6">
          ...
          <p className="text-slate-400">The user management console requires an authenticated admin.</p>
        </div>
      </div>
    );
  }
